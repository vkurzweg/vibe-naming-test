                        ...
                        >
                          <Box sx={{ width: '100%' }}>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: '0.75rem' }}>
                              ...
                              {/* Status tag in upper right corner - with dark text color */}
                              <Chip
                                label={getStatusLabel(request.status)}
                                sx={{
                                  backgroundColor: getStatusColor(request.status) + '40', // Adding transparency for lighter bg
                                ...
                                <>
                                  ...
                                  {request.status === 'submitted' && (
                                    <Button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        handleStatusChange(request.id, 'brand_review');
                                      }}
                                      color="primary"
                                      variant="outlined"
                                      size="small"
                                  ...
                                  {request.status === 'brand_review' && (
                                    <Button
                                      startIcon={<AccessTimeIcon />}
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        handleStatusChange(request.id, 'legal_review');
                                      }}
                                      color="primary"
                                      variant="outlined"
                                      size="small"
